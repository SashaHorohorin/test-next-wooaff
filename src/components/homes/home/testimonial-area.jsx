...
const testimonial_data = [
  {
    ...
    des: (
      <>
        Prioritizing the supply of transparent deliverables before addressing internal or 'organic' sources is a strategic move that can lead to smoother operations and better integration within the organization.
      </>
    ),
  },
  {
    ...
    des: (
      <>
        It's important to emphasize the significant supply of transparent deliverables before tackling the internal or 'organic' sources. This approach can enhance overall efficiency and alignment within the company.
      </>
    ),
  },
  {
    ...
    des: (
      <>
        Addressing the supply of transparent deliverables in a dramatic fashion before diving into the complexities of internal or 'organic' sources is a proactive strategy that can yield positive results in terms of organizational coherence and effectiveness.
      </>
    ),
  },
  {
