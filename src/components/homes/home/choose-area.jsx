...
const choose_data = {
  ...
  des: 'Efficiently provide clear deliverables upfront and can retroactively compare with internal or "organic" sources.',

  choose_list: [
    { title: "Enhance Your Learning Skills" },
    { title: "High-Quality Video & Audio Classes" },
    { title: "Complete Your Course and Receive a Certificate" },
  ],
};
