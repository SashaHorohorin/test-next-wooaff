...
const about_info = {
    ...
    sub_title:"Discover a Plethora of Creative Classes.",
    des: <>Efficiently provide clear outcomes from internal or "organic" sources. Skillfully leverage additional resources.</>,
    about_btn: "Read More"
}
